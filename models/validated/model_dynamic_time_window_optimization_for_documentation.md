...
|--------|-------|------------|
| Expected Annual Return | 9.95% | MODERATE |
| Annual Volatility | 13.27% | LOW |
| Sharpe Ratio | 0.60 | 0.7498 |
| Maximum Drawdown | 8.08% | LOW |
| Win Rate | 54.08% | MODERATE |
...
| Mean Return | 6.15% |
| Std Return | 43.55% |
| 5th Percentile | -65.38% |
| 95th Percentile | 79.38% |
