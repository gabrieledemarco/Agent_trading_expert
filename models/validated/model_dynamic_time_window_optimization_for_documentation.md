...
|--------|-------|------------|
| Expected Annual Return | 1.24% | POOR |
| Annual Volatility | 2.80% | LOW |
| Sharpe Ratio | -0.27 | 0.4425405706235204 |
| Maximum Drawdown | 2.18% | LOW |
| Win Rate | 51.19% | POOR |

### 5.2 Risk Assessment
- **Risk Level**: LOW
- **Return Level**: POOR
- **Risk-Return Ratio**: 0.44
...
| Mean Return | 1.07% |
| Std Return | 43.17% |
| 5th Percentile | -67.86% |
| 95th Percentile | 68.18% |
| Probability of Positive Return | 56.00% |
| Probability of >10% Loss | 34.00% |
