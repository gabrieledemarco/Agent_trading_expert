...
|--------|-------|------------|
| Expected Annual Return | 16.50% | GOOD |
| Annual Volatility | 13.73% | LOW |
| Sharpe Ratio | 1.06 | 1.2016 |
| Maximum Drawdown | 6.17% | LOW |
| Win Rate | 52.17% | GOOD |
...
| Mean Return | -1.48% |
| Std Return | 52.68% |
| 5th Percentile | -70.58% |
| 95th Percentile | 76.18% |
| Probability of Positive Return | 46.00% |
