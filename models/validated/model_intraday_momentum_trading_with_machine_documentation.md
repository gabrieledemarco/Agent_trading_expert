...
|--------|-------|------------|
| Expected Annual Return | 10.34% | MODERATE |
| Annual Volatility | 11.53% | LOW |
| Sharpe Ratio | 0.72 | 0.8964 |
| Maximum Drawdown | 8.42% | LOW |
| Win Rate | 54.42% | MODERATE |

### 5.2 Risk Assessment
- **Risk Level**: LOW
- **Return Level**: MODERATE
- **Risk-Return Ratio**: 0.90
...
| 95th Percentile | 56.62% |
| Probability of Positive Return | 55.00% |
| Probability of >10% Loss | 37.00% |
