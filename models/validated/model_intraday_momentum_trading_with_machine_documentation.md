...
|--------|-------|------------|
| Expected Annual Return | 28.35% | GOOD |
| Annual Volatility | 18.47% | MEDIUM |
| Sharpe Ratio | 1.43 | 1.5353 |
| Maximum Drawdown | 7.08% | MEDIUM |
| Win Rate | 53.08% | GOOD |

### 5.2 Risk Assessment
- **Risk Level**: MEDIUM
- **Return Level**: GOOD
- **Risk-Return Ratio**: 1.54
...
| Mean Return | 2.48% |
| Std Return | 55.22% |
| 5th Percentile | -90.34% |
| 95th Percentile | 71.36% |
| Probability of Positive Return | 54.00% |
