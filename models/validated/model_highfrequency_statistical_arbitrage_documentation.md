...
|--------|-------|------------|
| Expected Annual Return | 6.50% | MODERATE |
| Annual Volatility | 5.73% | LOW |
| Sharpe Ratio | 0.79 | 1.1342240412231128 |
| Maximum Drawdown | 3.99% | LOW |
| Win Rate | 56.35% | MODERATE |

### 5.2 Risk Assessment
- **Risk Level**: LOW
- **Return Level**: MODERATE
- **Risk-Return Ratio**: 1.13
...
| Mean Return | 3.22% |
| Std Return | 40.00% |
| 5th Percentile | -64.94% |
| 95th Percentile | 60.25% |
| Probability of Positive Return | 58.00% |
