...
|--------|-------|------------|
| Expected Annual Return | 8.26% | MODERATE |
| Annual Volatility | 11.07% | LOW |
| Sharpe Ratio | 0.57 | 0.7467 |
| Maximum Drawdown | 10.33% | LOW |
| Win Rate | 56.33% | MODERATE |
...
| Mean Return | -4.05% |
| Std Return | 54.13% |
| 5th Percentile | -101.89% |
| 95th Percentile | 71.78% |
