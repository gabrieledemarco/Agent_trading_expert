...
|--------|-------|------------|
| Expected Annual Return | -5.50% | POOR |
| Annual Volatility | 6.25% | LOW |
| Sharpe Ratio | -1.20 | 0.8797739429042011 |
| Maximum Drawdown | 7.08% | LOW |
| Win Rate | 47.22% | POOR |
...
| Mean Return | 1.95% |
| Std Return | 49.57% |
| 5th Percentile | -58.94% |
| 95th Percentile | 83.17% |
| Probability of Positive Return | 45.00% |
| Probability of >10% Loss | 45.00% |
