...
|--------|-------|------------|
| Expected Annual Return | 12.35% | MODERATE |
| Annual Volatility | 11.80% | LOW |
| Sharpe Ratio | 0.88 | 1.0465 |
| Maximum Drawdown | 11.25% | LOW |
| Win Rate | 57.25% | MODERATE |

### 5.2 Risk Assessment
- **Risk Level**: LOW
- **Return Level**: MODERATE
- **Risk-Return Ratio**: 1.05
...
| Mean Return | -0.06% |
| Std Return | 49.44% |
| 5th Percentile | -85.13% |
| 95th Percentile | 75.18% |
...
---
*Generated by ValidationAgent on 2026-04-28 12:40:18*
