...
|--------|-------|------------|
| Expected Annual Return | 21.83% | MODERATE |
| Annual Volatility | 19.87% | MEDIUM |
| Sharpe Ratio | 1.00 | 1.0987 |
| Maximum Drawdown | 11.33% | MEDIUM |
| Win Rate | 57.33% | MODERATE |

### 5.2 Risk Assessment
- **Risk Level**: MEDIUM
- **Return Level**: MODERATE
- **Risk-Return Ratio**: 1.10
...
| Mean Return | 0.34% |
| Std Return | 48.37% |
| 5th Percentile | -71.82% |
| 95th Percentile | 71.70% |
...
---
*Generated by ValidationAgent on 2026-04-28 12:40:17*
