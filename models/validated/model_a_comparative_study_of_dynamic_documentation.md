...
|--------|-------|------------|
| Expected Annual Return | 18.73% | GOOD |
| Annual Volatility | 15.47% | MEDIUM |
| Sharpe Ratio | 1.08 | 1.2113 |
| Maximum Drawdown | 8.33% | MEDIUM |
| Win Rate | 54.33% | GOOD |

### 5.2 Risk Assessment
- **Risk Level**: MEDIUM
- **Return Level**: GOOD
- **Risk-Return Ratio**: 1.21
...
| Mean Return | -9.25% |
| Std Return | 46.91% |
| 5th Percentile | -96.72% |
| 95th Percentile | 64.20% |
| Probability of Positive Return | 44.00% |
| Probability of >10% Loss | 47.00% |
...
---
*Generated by ValidationAgent on 2026-04-27 12:21:55*
