...
|--------|-------|------------|
| Expected Annual Return | 16.81% | GOOD |
| Annual Volatility | 12.74% | LOW |
| Sharpe Ratio | 1.13 | 1.318881579516772 |
| Maximum Drawdown | 6.16% | LOW |
| Win Rate | 29.29% | GOOD |

### 5.2 Risk Assessment
- **Risk Level**: LOW
- **Return Level**: GOOD
- **Risk-Return Ratio**: 1.32
...
| Std Return | 15.65% |
| 5th Percentile | -4.87% |
| 95th Percentile | 46.30% |
| Probability of Positive Return | 90.00% |
| Probability of >10% Loss | 3.00% |
...
---
*Generated by ValidationAgent on 2026-04-27 16:42:00*
