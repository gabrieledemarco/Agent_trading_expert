...
|--------|-------|------------|
| Expected Annual Return | -5.20% | POOR |
| Annual Volatility | 5.34% | LOW |
| Sharpe Ratio | -1.35 | 0.9739246608077693 |
| Maximum Drawdown | 10.44% | LOW |
| Win Rate | 48.02% | POOR |

### 5.2 Risk Assessment
- **Risk Level**: LOW
- **Return Level**: POOR
- **Risk-Return Ratio**: 0.97
...
| Mean Return | 3.62% |
| Std Return | 57.47% |
| 5th Percentile | -93.30% |
| 95th Percentile | 92.87% |
| Probability of Positive Return | 60.00% |
| Probability of >10% Loss | 35.00% |
...
---
*Generated by ValidationAgent on 2026-04-27 11:41:32*
