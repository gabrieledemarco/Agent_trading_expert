...
|--------|-------|------------|
| Expected Annual Return | 6.36% | MODERATE |
| Annual Volatility | 6.43% | LOW |
| Sharpe Ratio | 0.68 | 0.9899058904404092 |
| Maximum Drawdown | 8.73% | LOW |
| Win Rate | 51.59% | MODERATE |

### 5.2 Risk Assessment
- **Risk Level**: LOW
- **Return Level**: MODERATE
- **Risk-Return Ratio**: 0.99
...
| Mean Return | 0.08% |
| Std Return | 41.78% |
| 5th Percentile | -61.22% |
| 95th Percentile | 64.56% |
| Probability of Positive Return | 52.00% |
| Probability of >10% Loss | 44.00% |
