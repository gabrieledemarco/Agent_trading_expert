...
async def get_agents_status():
    ...
    # Keys are pre-normalised (lowercase, no spaces, no underscores) so the
    # lookup works regardless of how the caller spells the name.
    _CANONICAL_RAW = {
    ...
    # Pre-normalise keys once at call time
